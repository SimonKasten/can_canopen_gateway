...
CAN_FRAME Gateway::process_can(CAN_FRAME &f)
{
    ...
    if (decodedID == INIT_ID1_CANID)
    {
        ...
        set_nmt_state(ADrive_rx.INIT_ID1.befehl, servo1.getID());
    ...
    else if (decodedID == INIT_ID2_CANID)
    {
        ...
        set_nmt_state(ADrive_rx.INIT_ID2.befehl, servo2.getID());
    ...
    else if (decodedID == INIT_ELREST_CANID)
    {
        ...
        set_nmt_state(ADrive_rx.INIT_ELREST.befehl, elrest1.getID());
        // set_nmt_state(ADrive_rx.INIT_ELREST.befehl, elrest2.getID());
        // set_nmt_state(ADrive_rx.INIT_ELREST.befehl, elrest3.getID());
